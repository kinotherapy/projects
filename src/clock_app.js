		...
		return (
			<div id='wrapper'>
				<div id='controls-section'>
					<Panel label={'break'} value={this.state.break} adjust={this.adjust}/>
					<Panel label={'session'} value={this.state.session}	adjust={this.adjust}/>
				</div>
				<div id='display'>
					<div id='timer-label'>
					...
					<div id='playback'>
						<button id='start_stop' onClick={this.startstop}>
							<i className={this.state.status == 'running' ? "fa fa-pause" : "fa fa-play"} />
						</button>
		...
		return (
			<div className='panel'>
				...
				<div className='controls'>
					...
					<div className='length' id={this.props.label + '-length'}>
						{this.props.value}
					</div>
